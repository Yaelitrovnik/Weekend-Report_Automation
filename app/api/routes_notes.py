...
from app.review.notes import NoteValidationError
from app.review.notes import save_general_note as persist_general_note
from app.review.notes import save_module_note as persist_module_note
from app.review.notes import save_result_note as persist_result_note
from app.review.notes import save_splunk_note as persist_splunk_note
...
def save_module_note(
    ...
    try:
        note_id = persist_module_note(repo, run_id, module, SYSTEM_ACTOR, payload.get("note", ""))
